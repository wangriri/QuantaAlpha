...
import { Sparkles, Database, BarChart3, Settings as SettingsIcon, Workflow } from 'lucide-react';
import { useTaskContext } from '@/context/TaskContext';

export type PageId = 'home' | 'library' | 'backtest' | 'trace' | 'settings' | 'mining_dashboard';
